...
<<<<<<< HEAD
        EventController.shared.createEvent(name: eventName, description: descriptionTextView.text, user: user, type: .event, status: .open, space: pickedSpace, date: date.timeIntervalSince1970, startTime: eventStartingTime, endTime: eventEndingTime, isRecurring: false, recurringPeriod: nil) { (event) in
...
//            
//        }
>>>>>>> cb84b8f4ed7b859f158f9024d048c32b6b5fcd00
